...
in
{
  options.services.jigasi = with types; {
    enable = mkEnableOption (mdDoc "Jitsi Gateway to SIP - component of Jitsi Meet");
    ...
    xmppDomain = mkOption {
      ...
      description = mdDoc ''
        ...
        If null, {option}`services.jigasi.xmppHost` is used.
      '';
    };
    ...
    config = mkOption {
      ...
      '';
      description = mdDoc ''
        Contents of the {file}`sip-communicator.properties` configuration file for jigasi.
      '';
    };
  };
